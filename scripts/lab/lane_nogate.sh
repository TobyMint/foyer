...
$P /data/xbw/turnstile/TraceLab/replay/scripts/run_matrix.py --lane nogate --gpu 3 --port 30043 \
  --runs 'pois200_foyer_nogate:budget3:hw=0;target=0.95;horizon=0;base=resident'
bash /data/xbw/turnstile/scripts/lane_done.sh nogate pois200_foyer_nogate
