...
$P /data/xbw/turnstile/TraceLab/replay/scripts/run_matrix.py --lane rg4 --gpu 2 --port 30042 \
  --runs 'pois200_foyer_rg4:budget3:hw=0;target=0.95;horizon=0;base=resident;rgate=4'
bash /data/xbw/turnstile/scripts/lane_done.sh rg4 pois200_foyer_rg4
