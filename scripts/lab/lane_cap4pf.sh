#!/bin/bash
# 断崖测试：cap4 + prefill 批预算 16384->65536。对照 cap4_hc 213.0/3.93/63.4
...
$P /data/xbw/turnstile/TraceLab/replay/scripts/run_matrix.py --lane cap4pf --gpu 0 --port 30040 \
  --runs 'pois200_cap4_hc_pf64:static=4'
bash /data/xbw/turnstile/scripts/lane_done.sh cap4pf pois200_cap4_hc_pf64
