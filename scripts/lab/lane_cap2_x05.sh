...
$P /data/xbw/turnstile/TraceLab/replay/scripts/run_matrix.py --lane cap2_x05 --gpu 3 --port 30043 \
  --runs 'pois200_cap2_x05:static=2'
bash /data/xbw/turnstile/scripts/lane_done.sh cap2_x05 pois200_cap2_x05
