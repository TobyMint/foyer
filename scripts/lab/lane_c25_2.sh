...
$P /data/xbw/turnstile/TraceLab/replay/scripts/run_matrix.py --lane c25_2 --gpu 2 --port 30042 \
  --runs 'pois200_cap2_25:static=2'
bash /data/xbw/turnstile/scripts/lane_done.sh c25_2 pois200_cap2_25
