...
$P /data/xbw/turnstile/TraceLab/replay/scripts/run_matrix.py --lane c25_3 --gpu 3 --port 30043 \
  --runs 'pois200_cap3_25:static=3'
bash /data/xbw/turnstile/scripts/lane_done.sh c25_3 pois200_cap3_25
