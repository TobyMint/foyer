...
the per-step cost rises faster than the request count does. That non-monotonicity
is the first appearance of the mechanism that explains everything else.
