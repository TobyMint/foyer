...
rather than the admission decision: chunked prefill with stall-free batching
\cite{sarathi}, prefill/decode disaggregation \cite{distserve}, and cache-centric
scheduling \cite{mooncake}. Our \S\ref{sec:model} attributes 7--10\,ms of each
...
proportionally with $\overline{R}$, the two cancel and it does not. Our seven
measured configurations give 22.8--31.3\,ms across a running range of
1.04--1.62, i.e.\ a rise of about 8\,ms over 0.58---enough to cancel the gain.
